...
$routes->get('surat/keluarall', 'Surat::keluarall');
...
$routes->get('xibo', 'Room::xibo');
$routes->post('ruang', 'Ruang::index');
...
$routes->get('keputusan/add', 'Keputusan::add');
$routes->post('keputusan/insert', 'Keputusan::insert');
$routes->get('keputusan/invoice/(:num)', 'Keputusan::invoice/$1');
$routes->get('keputusan/upload/(:num)', 'Keputusan::upload/$1');
$routes->post('keputusan/upload/(:num)', 'Keputusan::processupload/$1');
