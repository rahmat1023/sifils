                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="invoice-title">
                                <h2>Nomor Surat</h2>
                                <div class="invoice-number"><span id="nosusun"><?= $keluar->nosusun; ?> </span> <button class="btn btn-sm btn-outline-secondary" onclick="CopyToClipboard('nosusun')" id="toastr-1"> <i class="far fa-copy"></i>Copy</button></div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <?php if ($keluar->file && (session('id') == $keluar->pembuat || session('role') == 'admin')) : ?>
